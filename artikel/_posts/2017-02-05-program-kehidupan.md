...
Dengan tujuan tersebut sebagai fondasi, Unix dikembangkan dengan prinsip: *simple, short, clear, modular, and extensible*. Prinsip tersebut membuat Unix menjadi OS terbaik sepanjang masa. Saat ini, prinsip Unix (Unix Philosophy) menjadi pedoman *developer* ketika membangun program.
